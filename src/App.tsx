    ...
    <div className="p-12 max-w-7xl mx-auto">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-12">
        <div>
          ...
          <p className="text-slate-500 text-lg">
            Califica el impacto de los reconocimientos enviados por el equipo.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-amber-50 border border-amber-100 rounded-[2rem] p-6">
          ...
          <p className="text-4xl font-bold text-amber-800">{stats.sinEvaluar}</p>
        </div>
        ...
        <div className="bg-emerald-50 border border-emerald-100 rounded-[2rem] p-6">
          ...
          <p className="text-4xl font-bold text-emerald-800">{stats.evaluadas}</p>
        </div>
        ...
        <div className="bg-red-50 border border-red-100 rounded-[2rem] p-6">
          ...
          <p className="text-4xl font-bold text-red-800">{stats.descartadas}</p>
        </div>
      </div>
